...
Class CSVClass extends CSVModel{
    ...
    function __construct(){ 
        ...
        $this->_checks_array = ['addr', 'point', 'phone'];
    ...
    public function processCSVFile(){ 
        ...
        if(isset($this->_opt['save']) && $this->_opt['save'] == 1){ 
            ...
            if(!isset($this->_opt['promise'])){
                ...
                echo '<br><br><span class="info-info">Initial CSV file: '.count($this->_file).' rows</span>';
            ...
            if(!isset($this->_opt['promise'])){
                echo '<br><br><span class="info-info">Data statistics</span>: <br> CSV data contains '.$csv_rows_count.' rows <br> DB contains: '.$db_rows_count.' rows';
            ...
            if($this->preUpdateRequirements()){
                ...
                echo 'Flush PREUpdate requirements done';
            ...
            if($this->flushUpdateRequirements()){
                ...
                echo 'Flush Update requirements done';
    ...
    private function deleteNonUniqueData($coinsidence_patterns, $c_pattern){  
                ...
                if($compared_addr == $pattern){                    
                    ...
                    if($repeats_array[$pattern] > 1){
                        ...
                        if(!isset($this->_opt['promise'])){
                            ...
                            echo '<span class="warning-info">Deleted pattern:</span> '.$compared_addr.' : at row: '.$row_count.'<br>';
        ...
        if(!isset($this->_opt['promise'])){
            ...
            echo '<span class="warning-info"> Deleted (pattern: '.$c_pattern.'): '.$rows_deleted. ' rows: '.substr($rows_log,0,strlen($rows_log)-1).'</span><br><br>';
            
            echo '<span class="info-info">Optimized CSV file: '.count($this->_file).' rows</span>'; 
